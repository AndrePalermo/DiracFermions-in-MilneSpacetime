...
#-------------------------------------------------------------------#
#-------------------------------------------------------------------#
#--------------- DEFINITION OF THE SPECIAL FUNCTIONS ---------------#


# ********** All functions Faster ********** #
# ****************************************** #
...
# *********** \mathrm {f}^* ************* #
# *************************************** #
def cfw(τ, μ, mass, px, py):
    """
        Returns f_w^* (i.e. the conjugate of f_w)
    """
    result = (mp.pi / 4) * mp.exp(-mp.pi * μ) * (
        mp.hankel2(-1/2 - 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ) * mp.hankel1(1/2 + 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ)
    )
    return result
...
# *********** \mathrm {z}^* ************* #
# *************************************** #
def czw(τ, μ, mass, px, py):
    """
        Returns z_w^* (i.e. the conjugate of z_w)
    """
    result = (mp.pi / 4) * (
        mp.hankel2(1/2 - 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ) * mp.hankel2(-1/2 + 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ)
        - mp.hankel2(-1/2 - 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ) * mp.hankel2(1/2 + 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ)
...
# *********** \mathrm {w}^* ************* #
# *************************************** #
def cww(τ, μ, mass, px, py):
    """
        Returns w_w^* (i.e. the conjugate of w_w)
    """
    result = (mp.pi / 4) * (
        mp.hankel2(-1/2 - 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ) * mp.hankel2(1/2 + 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ)
        + mp.hankel2(1/2 - 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ) * mp.hankel2(-1/2 + 1j*μ, mp.sqrt(mass**2 + px**2 + py**2) * τ)
